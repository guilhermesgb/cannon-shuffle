...
public class LightningExplosion extends Explosion{
	...
	final int SPRITES_COLUMN=3;// (Constants.EXPLOSION_SPRITE_WIDTH_TOTAL)/Constants.EXPLOSION_SPRITE_WIDTH;
	...
	static Texture sheet = new Texture(Gdx.files.internal("lightning_bullet.png"));
	int current_row = 0;
	int current_column= 0;

	public LightningExplosion(Vector2 position){
